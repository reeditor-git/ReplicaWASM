        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentPrice = table.Column<decimal>(type: "decimal(6,2)", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("d4e6d597-950b-4d87-b568-9ce087f3c79f"), new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "admin@replica.com", "Admin", "*/Image/User/default-user-image.jpg", "Replica", "Reeditor", "admin", "0975440309", new Guid("6fa17fba-626d-481c-81cd-bbda29109fab") });
